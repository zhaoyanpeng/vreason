...
model_name=dist_nine_new_gpt
model_file=00055250.pth
...
model.embedder.mode=gpt
model.embedder.aug_prob=0.5
model.embedder.name=NeoTokenEncHead
model.encoder.name=DummyEncHead 
model.decoder.name=NeoGPTDecHead 
model.decoder.num_layer=2
model.decoder.block_size=1024
model.decoder.contx_size=817
model.decoder.infer_mode=ll
