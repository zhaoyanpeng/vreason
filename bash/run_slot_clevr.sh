...
data_root=/home/s1847450/data/scenedata/cl-bbox

data_name=$vqgan_time"_"$vqgan_name

model_name=slot_test
model_name=slot_decay_test
model_name=slot_decay_test2
model_name=test
model_name=slot_test_standard
model_name=slot_standard_seed-$seed
logname=$model_name
...
running.epochs=1000 running.batch_size=32 running.peep_rate=50 running.save_rate=1e10 running.save_epoch=True
data.train_samples=null data.eval_samples=[0,1024] data.test_samples=null
data.data_name=\"CLEVR_train_scenes.70k.json\"

"

#optimizer.warmup=True optimizer.warmup_steps=1e4 optimizer.batch_sch=True
...
#data.train_samples=[0,128] data.eval_samples=[0,128] data.test_samples=null
